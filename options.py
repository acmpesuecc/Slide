...
def main_menu_o():
    while True:
        ...
        PLAY_BUTTON = Button(image=pygame.image.load("assets/play_back.png"), pos=(420, 250), 
                            text_input="MUSIC ON/OFF", font=get_font(20), base_color="#000000", hovering_color="White")
        

        QUIT_BUTTON = Button(image=pygame.image.load("assets/quit_back.png"), pos=(420, 550), 
